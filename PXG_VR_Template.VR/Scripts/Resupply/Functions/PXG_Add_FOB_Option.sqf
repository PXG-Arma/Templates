...
_action = ["BuildFOB","Build FOB","",{[_target] execVM "Scripts\Resupply\Functions\PXG_Start_FOB_Deploy.sqf"},{_player getVariable "ACE_IsEngineer" == 2 }] call ace_interact_menu_fnc_createAction;
